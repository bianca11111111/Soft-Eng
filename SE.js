        ...
        <section class="featured-section">
            ...
            <div class="archive-actions">
                <button class="btn btn-download">
                    <i class="fa-solid fa-download"></i> Download Selection
                </button>
            ...
            <div class="archive-display">
                <h3 class="empty-msg">No Archived Files</h3>
            </div>
        </section>
    `;
...
function setupArchiveHandlers() {
    ...
    if (restoreBtn) {
        restoreBtn.addEventListener('click', () => {
            ...
            if (archiveDisplay) {
                archiveDisplay.innerHTML = '<h3 class="empty-msg">Files restored successfully!</h3>';
                setTimeout(() => {
                    archiveDisplay.innerHTML = '<h3 class="empty-msg">No Archived Files</h3>';
                }, 2000);
            }
        });
    }
...
function setActiveNavItem(link) {
    const activeItem = dashboardSidebar.querySelector('li.active');
    if (activeItem) {
